(() => {
  ...
  const ZH = {
    ...
    "We rate the greatest Champions League player with a weighted UEFA GOAT Score. Each metric is normalized first, then combined so goals, titles, appearances, and honors can be compared on the same scale.": "我们用加权的 UEFA GOAT Score 来评选欧冠历史最佳球员。所有指标都会先做归一化，再进行合成，这样进球、冠军、出场和荣誉就能在同一尺度上比较。",
    "UEFA GOAT Score": "UEFA GOAT Score",
    "0.25 × Goals + 0.15 × Assists + 0.20 × Knockout G+A + 0.15 × Titles + 0.10 × Appearances + 0.10 × Best XI + 0.05 × Peak": "0.25 × 进球 + 0.15 × 助攻 + 0.20 × 淘汰赛进球+助攻 + 0.15 × 冠军 + 0.10 × 出场 + 0.10 × 最佳阵容 + 0.05 × 巅峰",
    "Goals · 25%": "进球 · 25%",
