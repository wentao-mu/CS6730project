(() => {
  ...
  const ZH = {
    ...
    "Goals, trophies, influence, and unforgettable nights under the lights. The question divides generations and ignites debate across Europe. Here is a curated, data-driven way to frame the argument.": "进球、冠军、影响力，以及无数难忘的欧战之夜。这个问题跨越世代，引发全欧洲讨论。这里提供一套精炼且数据驱动的分析框架。",
    ...
    "The “best” is never just goals. It is a blend of individual brilliance, team success, and influence across UEFA competitions.": "“最佳”从来不只是进球，而是个人能力、团队成就和欧战影响力的综合体现。",
    "European Trophies": "欧洲荣誉",
    "Champions League wins, Super Cups, and domestic dominance that defined eras.": "欧冠冠军、超级杯与联赛统治，共同定义一个时代。",
    "Iconic Moments": "标志性时刻",
    "Finals, comebacks, and decisive performances when the pressure was highest.": "在决赛、逆转和高压局中给出决定性表现。",
    "Longevity": "持续性",
    "Consistency at elite levels across multiple seasons, leagues, and teammates.": "跨赛季、跨联赛保持顶级稳定输出。",
    "Innovation": "创新性",
    "Style, technique, or tactical impact that changed how football is played.": "以风格、技术或战术影响改变比赛方式。",
    "Leadership": "领导力",
    "Captains, culture-setters, and players who elevated everyone around them.": "能建立文化并提升全队水准的球员。",
    "Numbers & Narrative": "数据与叙事",
    "Records matter, but so does the story the football world still tells.": "纪录重要，足球世界的长期叙事同样重要。",
    "Debate Route": "辩论路径",
    ...
    "Ronaldo vs Messi Visual Compare": "C罗 vs 梅西可视化对比",
    "Radar + bar view built from local datasets and key UEFA record indicators.": "基于本地数据集与欧足联关键纪录指标的雷达图+柱状图视图。",
    "Star Profile": "星图画像",
    "Normalized across six indicators.": "基于6项指标归一化。",
    "Bar Comparison": "柱状图对比",
    "Absolute values for each metric.": "展示各指标绝对值。",
